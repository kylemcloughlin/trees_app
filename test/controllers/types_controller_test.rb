...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { botanical_name: @type.botanical_name, common_name: @type.common_name } }, as: :json
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { botanical_name: @type.botanical_name, common_name: @type.common_name } }, as: :json
    assert_response 200
  end
